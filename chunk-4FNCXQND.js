  ...
  connect() {
    ...
    this.client = new import_stompjs.Client({
      ...
      onConnect: () => {
        ...
        this.client?.subscribe("/topic/torre-control", (message) => {
  ...
  watchFlight(flightId) {
    return new Observable((subscriber) => {
      ...
      const trySubscribe = () => {
        ...
        const sub = this.client.subscribe(`/topic/flights/${flightId}`, (message) => {
  ...
  watchPush(userId) {
    return new Observable((subscriber) => {
      ...
      const trySubscribe = () => {
        ...
        const sub = this.client.subscribe(`/topic/push/${userId}`, (message) => {
          subscriber.next(JSON.parse(message.body));
        });
        subscriber.add(() => sub.unsubscribe());
      };
...
// src/app/core/services/critical-alert.service.ts
var CriticalAlertService = class _CriticalAlertService {
  /** Claves `${flightId}:${timerType}` ya notificadas, para no repetir cada segundo mientras siga urgente. */
  alerted = /* @__PURE__ */ new Set();
  get supported() {
  ...
  fire(flight, timer) {
    const notification = new Notification(`\u{1F6A8} \xA1Alerta Critica! Vuelo ${flight.flightNumber} a 5 minutos`, {
  ...
  static \u0275fac = function CriticalAlertService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _CriticalAlertService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _CriticalAlertService, factory: _CriticalAlertService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(CriticalAlertService, [{
    type: Injectable,
    args: [{ providedIn: "root" }]
  }], null, null);
})();

// src/app/core/services/pip-timers.service.ts
var PipTimersService = class _PipTimersService {
  ...
  static \u0275fac = function PipTimersService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _PipTimersService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _PipTimersService, factory: _PipTimersService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(PipTimersService, [{
    type: Injectable,
    args: [{ providedIn: "root" }]
  }], null, null);
})();

// src/app/features/torre-control/torre-control.component.ts
var _forTrack0 = ($index, $item) => $item.id;
function TorreControlComponent_Conditional_22_Template(rf, ctx) {
  if (rf & 1) {
    const _r1 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "button", 39);
    \u0275\u0275listener("click", function TorreControlComponent_Conditional_22_Template_button_click_0_listener() {
      \u0275\u0275restoreView(_r1);
      const ctx_r1 = \u0275\u0275nextContext();
      return \u0275\u0275resetView(ctx_r1.togglePip());
    });
    \u0275\u0275element(1, "i", 40);
    \u0275\u0275text(2);
    \u0275\u0275elementEnd();
  ...
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate1("", ctx_r1.pip.isOpen() ? "Cerrar Flotante" : "Fijar Cronometros en Pantalla", " ");
  }
}
function TorreControlComponent_Conditional_67_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 32);
  }
}
function TorreControlComponent_Conditional_68_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "i", 33);
  }
}
function TorreControlComponent_Conditional_70_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 34);
    \u0275\u0275element(1, "div", 41);
    \u0275\u0275elementStart(2, "p", 42);
    \u0275\u0275text(3, "Cargando vuelos activos...");
    \u0275\u0275elementEnd()();
  }
}
function TorreControlComponent_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35);
    \u0275\u0275element(1, "i", 43);
    \u0275\u0275elementStart(2, "p", 44);
    \u0275\u0275text(3, "No hay vuelos activos en este momento.");
    \u0275\u0275elementEnd();
    \u0275\u0275elementStart(4, "a", 45);
    \u0275\u0275text(5, "Registrar vuelo");
    \u0275\u0275elementEnd()();
  }
}
function TorreControlComponent_Conditional_72_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 46);
    \u0275\u0275element(1, "app-flight-card", 47);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const flight_r3 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("flight", flight_r3);
  }
}
function TorreControlComponent_Conditional_72_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 36);
    \u0275\u0275repeaterCreate(1, TorreControlComponent_Conditional_72_For_2_Template, 2, 1, "div", 46, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const ctx_r1 = \u0275\u0275nextContext();
    \u0275\u0275advance();
    \u0275\u0275repeater(ctx_r1.flights());
  }
}
function TorreControlComponent_Conditional_74_Template(rf, ctx) {
  if (rf & 1) {
    const _r4 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 48)(1, "div", 49);
    \u0275\u0275element(2, "i", 50);
    \u0275\u0275elementStart(3, "div", 27)(4, "strong", 51);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function TorreControlComponent_Conditional_74_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r4);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const t_r5 = ctx;
    \u0275\u0275classProp("text-bg-success", t_r5.type === "success")("text-bg-danger", t_r5.type === "error");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("bi-check-circle-fill", t_r5.type === "success")("bi-x-circle-fill", t_r5.type === "error");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(t_r5.type === "success" ? "Sincronizacion completa" : "Error de sincronizacion");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(t_r5.message);
  }
}
var TorreControlComponent = class _TorreControlComponent {
  flightService = inject(FlightService);
  ws = inject(WebSocketService);
  push = inject(PushNotificationService);
  auth = inject(AuthService);
  criticalAlert = inject(CriticalAlertService);
  pip = inject(PipTimersService);
  flightsMap = signal(/* @__PURE__ */ new Map(), ...ngDevMode ? [{ debugName: "flightsMap" }] : (
    /* istanbul ignore next */
    []
  ));
  flights = computed(() => Array.from(this.flightsMap().values()).sort((a, b) => {
  ...
  // --- Top Metrics -----------------------------------------------------
  flightsHoy = signal(0, ...ngDevMode ? [{ debugName: "flightsHoy" }] : (
    /* istanbul ignore next */
    []
  ));
  liveStats = computed(() => {
    ...
    const eficiencia = enProceso === 0 ? 100 : Math.round((enProceso - criticos) / enProceso * 1e3) / 10;
    return { enProceso, criticos, eficiencia };
  }, ...ngDevMode ? [{ debugName: "liveStats" }] : (
    /* istanbul ignore next */
    []
  ));
  // --- Sincronizacion desde Google Sheets (CSV) -------------------------
  syncUrl = signal("", ...ngDevMode ? [{ debugName: "syncUrl" }] : (
    /* istanbul ignore next */
    []
  ));
    ...
    this.flightService.syncFromSheet(url).subscribe({
      next: (result) => {
        ...
        if (result.omitidos > 0)
          parts.push(`${result.omitidos} omitidos`);
        if (result.errores > 0)
          parts.push(`${result.errores} con error`);
  ...
  showToast(type, message) {
    ...
    this.toastTimeoutId = setTimeout(() => this.toast.set(null), 6e3);
  }
  ...
  static \u0275fac = function TorreControlComponent_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _TorreControlComponent)();
  };
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TorreControlComponent, selectors: [["app-torre-control"]], decls: 75, vars: 16, consts: [[1, "container-fluid", "py-4"], [1, "d-flex", "flex-wrap", "align-items-center", "justify-content-between", "gap-3", "mb-4"], [1, "h3", "mb-1"], [1, "d-flex", "align-items-center", "gap-2", "text-body-secondary", "small"], [1, "conn-dot"], [1, "d-flex", "align-items-center", "gap-3"], [1, "legend", "d-none", "d-md-flex"], [1, "legend-item"], [1, "dot", "dot-ok"], [1, "dot", "dot-warning"], [1, "dot", "dot-critical"], [1, "dot", "dot-expired"], ["type", "button", 1, "btn", "btn-outline-secondary", "btn-action"], ["routerLink", "/nuevo-vuelo", 1, "btn", "btn-primary", "btn-action"], [1, "bi", "bi-plus-lg", "me-2"], [1, "row", "g-3", "mb-4"], [1, "col-6", "col-lg-3"], [1, "metric-card", "fade-in"], [1, "metric-icon"], [1, "bi", "bi-calendar-check"], [1, "metric-value"], [1, "metric-label"], [1, "bi", "bi-arrow-repeat"], [1, "bi", "bi-exclamation-triangle-fill"], [1, "bi", "bi-speedometer2"], [1, "card", "fade-in", "sync-panel", "mb-4"], [1, "d-flex", "flex-wrap", "align-items-end", "gap-3"], [1, "flex-grow-1"], ["for", "csvUrl", 1, "form-label", "small", "fw-semibold", "mb-1"], [1, "bi", "bi-filetype-csv", "me-1"], ["id", "csvUrl", "type", "url", "placeholder", "https://docs.google.com/spreadsheets/d/.../pub?output=csv", 1, "form-control", 3, "ngModelChange", "ngModel", "disabled"], ["type", "button", 1, "btn", "btn-primary", "btn-action", 3, "click", "disabled"], [1, "spinner-border", "spinner-border-sm", "me-2"], [1, "bi", "bi-cloud-arrow-down", "me-2"], [1, "text-center", "text-body-secondary", "py-5"], [1, "empty-state", "text-center", "py-5"], [1, "row", "g-3"], [1, "toast-host"], [1, "toast", "show", "fade-in", 3, "text-bg-success", "text-bg-danger"], ["type", "button", 1, "btn", "btn-outline-secondary", "btn-action", 3, "click"], [1, "bi", "bi-pip", "me-2"], ["role", "status", 1, "spinner-border"], [1, "mt-3"], [1, "bi", "bi-airplane", "display-4", "text-body-secondary"], [1, "mt-3", "text-body-secondary"], ["routerLink", "/nuevo-vuelo", 1, "btn", "btn-outline-primary", "btn-action", "mt-2"], [1, "col-12", "col-sm-6", "col-lg-4", "col-xxl-3"], [3, "flight"], [1, "toast", "show", "fade-in"], [1, "d-flex", "align-items-start", "gap-2", "p-3"], [1, "bi", "fs-5"], [1, "d-block", "mb-1"], [1, "small"], ["type", "button", 1, "btn-close", "btn-close-white", 3, "click"]], template: function TorreControlComponent_Template(rf, ctx) {
    if (rf & 1) {
      \u0275\u0275elementStart(0, "div", 0)(1, "div", 1)(2, "div")(3, "h1", 2);
      \u0275\u0275text(4, "Torre de Control");
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(21, "Vencido");
      \u0275\u0275elementEnd()();
      \u0275\u0275conditionalCreate(22, TorreControlComponent_Conditional_22_Template, 3, 1, "button", 12);
      \u0275\u0275elementStart(23, "a", 13);
      \u0275\u0275element(24, "i", 14);
      \u0275\u0275text(25, "Nuevo vuelo ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(26, "div", 15)(27, "div", 16)(28, "div", 17)(29, "div", 18);
      \u0275\u0275element(30, "i", 19);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(42, "En Proceso");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(43, "div", 16)(44, "div", 17)(45, "div", 18);
      \u0275\u0275element(46, "i", 23);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(58, "Eficiencia");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(59, "div", 25)(60, "div", 26)(61, "div", 27)(62, "label", 28);
      \u0275\u0275element(63, "i", 29);
      \u0275\u0275text(64, "URL publica CSV de Google Sheets ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(65, "input", 30);
      \u0275\u0275listener("ngModelChange", function TorreControlComponent_Template_input_ngModelChange_65_listener($event) {
        return ctx.syncUrl.set($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(66, "button", 31);
      \u0275\u0275listener("click", function TorreControlComponent_Template_button_click_66_listener() {
        return ctx.syncFromSheet();
      });
      \u0275\u0275conditionalCreate(67, TorreControlComponent_Conditional_67_Template, 1, 0, "span", 32)(68, TorreControlComponent_Conditional_68_Template, 1, 0, "i", 33);
      \u0275\u0275text(69, " Sincronizar Vuelos ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(70, TorreControlComponent_Conditional_70_Template, 4, 0, "div", 34)(71, TorreControlComponent_Conditional_71_Template, 6, 0, "div", 35)(72, TorreControlComponent_Conditional_72_Template, 3, 0, "div", 36);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(73, "div", 37);
      \u0275\u0275conditionalCreate(74, TorreControlComponent_Conditional_74_Template, 9, 10, "div", 38);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_13_0;
      \u0275\u0275advance(6);
      \u0275\u0275classProp("conn-on", ctx.connected());
      \u0275\u0275advance();
      \u0275\u0275textInterpolate1(" ", ctx.connected() ? "Tiempo real conectado" : "Conectando...", " ");
      \u0275\u0275advance(15);
      \u0275\u0275conditional(ctx.pip.supported ? 22 : -1);
      \u0275\u0275advance(10);
      \u0275\u0275textInterpolate(ctx.flightsHoy());
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate(ctx.liveStats().enProceso);
      \u0275\u0275advance(4);
      \u0275\u0275classProp("metric-alert", ctx.liveStats().criticos > 0);
      \u0275\u0275advance(4);
      \u0275\u0275textInterpolate(ctx.liveStats().criticos);
      \u0275\u0275advance(8);
      \u0275\u0275textInterpolate1("", ctx.liveStats().eficiencia, "%");
      \u0275\u0275advance(9);
      \u0275\u0275property("ngModel", ctx.syncUrl())("disabled", ctx.syncing());
      \u0275\u0275advance();
      \u0275\u0275property("disabled", !ctx.syncUrl().trim() || ctx.syncing());
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.syncing() ? 67 : 68);
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.loading() ? 70 : ctx.flights().length === 0 ? 71 : 72);
      \u0275\u0275advance(4);
      \u0275\u0275conditional((tmp_13_0 = ctx.toast()) ? 74 : -1, tmp_13_0);
    }
  }, dependencies: [RouterLink, FormsModule, DefaultValueAccessor, NgControlStatus, NgModel, FlightCardComponent], styles: ["\n.conn-dot[_ngcontent-%COMP%] {\n  display: inline-block;\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background: var(--tc-critical);\n  transition: background-color 0.3s ease;\n}\n.conn-dot.conn-on[_ngcontent-%COMP%] {\n  background: var(--tc-ok);\n  box-shadow: 0 0 6px var(--tc-ok);\n}\n.legend[_ngcontent-%COMP%] {\n  gap: 1rem;\n  font-size: 0.78rem;\n  color: var(--tc-muted);\n}\n.legend-item[_ngcontent-%COMP%] {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n}\n.dot[_ngcontent-%COMP%] {\n  width: 9px;\n  height: 9px;\n  border-radius: 50%;\n  display: inline-block;\n}\n.dot-ok[_ngcontent-%COMP%] {\n  background: var(--tc-ok);\n}\n.dot-warning[_ngcontent-%COMP%] {\n  background: var(--tc-warning);\n}\n.dot-critical[_ngcontent-%COMP%] {\n  background: var(--tc-critical);\n}\n.dot-expired[_ngcontent-%COMP%] {\n  background: var(--tc-critical);\n  animation: _ngcontent-%COMP%_legend-blink 1.1s ease-in-out infinite;\n}\n@keyframes _ngcontent-%COMP%_legend-blink {\n  0%, 100% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.35;\n  }\n}\n.empty-state[_ngcontent-%COMP%] {\n  border: 1px dashed var(--tc-border);\n  border-radius: 1rem;\n}\n.metric-card[_ngcontent-%COMP%] {\n  background: var(--tc-surface);\n  border: 1px solid var(--tc-border);\n  border-radius: 1rem;\n  padding: 1.15rem 1.25rem;\n  backdrop-filter: blur(var(--tc-glass-blur, 0));\n  -webkit-backdrop-filter: blur(var(--tc-glass-blur, 0));\n  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.2);\n  transition: border-color 0.3s ease, transform 0.2s ease;\n  height: 100%;\n}\n.metric-card[_ngcontent-%COMP%]:hover {\n  border-color: color-mix(in srgb, var(--tc-primary) 40%, var(--tc-border));\n  transform: translateY(-2px);\n}\n.metric-card.metric-alert[_ngcontent-%COMP%] {\n  border-color: color-mix(in srgb, var(--tc-critical) 55%, var(--tc-border));\n}\n.metric-icon[_ngcontent-%COMP%] {\n  width: 2.5rem;\n  height: 2.5rem;\n  border-radius: 0.65rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.15rem;\n  color: var(--tc-primary);\n  background: color-mix(in srgb, var(--tc-primary) 16%, transparent);\n  margin-bottom: 0.65rem;\n}\n.metric-card.metric-alert[_ngcontent-%COMP%]   .metric-icon[_ngcontent-%COMP%] {\n  color: var(--tc-critical);\n  background: color-mix(in srgb, var(--tc-critical) 16%, transparent);\n}\n.metric-value[_ngcontent-%COMP%] {\n  font-size: 1.9rem;\n  font-weight: 800;\n  font-variant-numeric: tabular-nums;\n  line-height: 1.1;\n}\n.metric-label[_ngcontent-%COMP%] {\n  font-size: 0.78rem;\n  color: var(--tc-muted);\n  margin-top: 0.15rem;\n}\n.sync-panel[_ngcontent-%COMP%] {\n  padding: 1.1rem 1.25rem;\n}\n.toast-host[_ngcontent-%COMP%] {\n  position: fixed;\n  bottom: 1.25rem;\n  right: 1.25rem;\n  z-index: 1080;\n  max-width: min(420px, calc(100vw - 2.5rem));\n}\n.toast-host[_ngcontent-%COMP%]   .toast[_ngcontent-%COMP%] {\n  display: block;\n  border-radius: 0.75rem;\n  box-shadow: 0 12px 32px rgba(0, 0, 0, 0.35);\n  border: none;\n}\n/*# sourceMappingURL=torre-control.component.css.map */"] });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(TorreControlComponent, [{
    type: Component,
    args: [{ selector: "app-torre-control", standalone: true, imports: [RouterLink, FormsModule, FlightCardComponent], template: `<div class="container-fluid py-4">
  <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-4">
    <div>
      <h1 class="h3 mb-1">Torre de Control</h1>
      <div class="d-flex align-items-center gap-2 text-body-secondary small">
        <span class="conn-dot" [class.conn-on]="connected()"></span>
    ...
    <div class="d-flex align-items-center gap-3">
      <div class="legend d-none d-md-flex">
        <span class="legend-item"><i class="dot dot-ok"></i>A tiempo</span>
        <span class="legend-item"><i class="dot dot-warning"></i>Proximo a vencer</span>
        <span class="legend-item"><i class="dot dot-critical"></i>Critico</span>
        <span class="legend-item"><i class="dot dot-expired"></i>Vencido</span>
      </div>
      @if (pip.supported) {
        <button type="button" class="btn btn-outline-secondary btn-action" (click)="togglePip()">
          <i class="bi bi-pip me-2"></i>{{ pip.isOpen() ? 'Cerrar Flotante' : 'Fijar Cronometros en Pantalla' }}
        </button>
      }
      <a routerLink="/nuevo-vuelo" class="btn btn-primary btn-action">
        <i class="bi bi-plus-lg me-2"></i>Nuevo vuelo
      </a>
    </div>
  </div>
  ...
  <div class="row g-3 mb-4">
    <div class="col-6 col-lg-3">
      <div class="metric-card fade-in">
        ...
        <div class="metric-value">{{ flightsHoy() }}</div>
    ...
    <div class="col-6 col-lg-3">
      <div class="metric-card fade-in">
        ...
        <div class="metric-value">{{ liveStats().enProceso }}</div>
        <div class="metric-label">En Proceso</div>
      </div>
    </div>
    <div class="col-6 col-lg-3">
      <div class="metric-card fade-in" [class.metric-alert]="liveStats().criticos > 0">
        <div class="metric-icon"><i class="bi bi-exclamation-triangle-fill"></i></div>
        <div class="metric-value">{{ liveStats().criticos }}</div>
        <div class="metric-label">Criticos</div>
      </div>
    </div>
    <div class="col-6 col-lg-3">
      <div class="metric-card fade-in">
        <div class="metric-icon"><i class="bi bi-speedometer2"></i></div>
        <div class="metric-value">{{ liveStats().eficiencia }}%</div>
  ...
  <div class="card fade-in sync-panel mb-4">
    <div class="d-flex flex-wrap align-items-end gap-3">
      <div class="flex-grow-1">
        <label for="csvUrl" class="form-label small fw-semibold mb-1">
          <i class="bi bi-filetype-csv me-1"></i>URL publica CSV de Google Sheets
        </label>
        <input
          id="csvUrl"
          type="url"
          ...
          [ngModel]="syncUrl()"
          (ngModelChange)="syncUrl.set($event)"
          [disabled]="syncing()"
        />
      </div>
      <button
  ...
  @if (loading()) {
    <div class="text-center text-body-secondary py-5">
      ...
      <p class="mt-3">Cargando vuelos activos...</p>
    </div>
  } @else if (flights().length === 0) {
    <div class="empty-state text-center py-5">
      <i class="bi bi-airplane display-4 text-body-secondary"></i>
      <p class="mt-3 text-body-secondary">No hay vuelos activos en este momento.</p>
      <a routerLink="/nuevo-vuelo" class="btn btn-outline-primary btn-action mt-2">Registrar vuelo</a>
    </div>
  } @else {
    <div class="row g-3">
...
<!-- Toast de resultado de sincronizacion -->
<div class="toast-host">
  @if (toast(); as t) {
    <div class="toast show fade-in" [class.text-bg-success]="t.type === 'success'" [class.text-bg-danger]="t.type === 'error'">
      <div class="d-flex align-items-start gap-2 p-3">
        <i class="bi fs-5" [class.bi-check-circle-fill]="t.type === 'success'" [class.bi-x-circle-fill]="t.type === 'error'"></i>
        <div class="flex-grow-1">
          <strong class="d-block mb-1">{{ t.type === 'success' ? 'Sincronizacion completa' : 'Error de sincronizacion' }}</strong>
...
`, styles: ["/* src/app/features/torre-control/torre-control.component.css */\n.conn-dot {\n  display: inline-block;\n  width: 8px;\n  height: 8px;\n  border-radius: 50%;\n  background: var(--tc-critical);\n  transition: background-color 0.3s ease;\n}\n.conn-dot.conn-on {\n  background: var(--tc-ok);\n  box-shadow: 0 0 6px var(--tc-ok);\n}\n.legend {\n  gap: 1rem;\n  font-size: 0.78rem;\n  color: var(--tc-muted);\n}\n.legend-item {\n  display: inline-flex;\n  align-items: center;\n  gap: 0.35rem;\n}\n.dot {\n  width: 9px;\n  height: 9px;\n  border-radius: 50%;\n  display: inline-block;\n}\n.dot-ok {\n  background: var(--tc-ok);\n}\n.dot-warning {\n  background: var(--tc-warning);\n}\n.dot-critical {\n  background: var(--tc-critical);\n}\n.dot-expired {\n  background: var(--tc-critical);\n  animation: legend-blink 1.1s ease-in-out infinite;\n}\n@keyframes legend-blink {\n  0%, 100% {\n    opacity: 1;\n  }\n  50% {\n    opacity: 0.35;\n  }\n}\n.empty-state {\n  border: 1px dashed var(--tc-border);\n  border-radius: 1rem;\n}\n.metric-card {\n  background: var(--tc-surface);\n  border: 1px solid var(--tc-border);\n  border-radius: 1rem;\n  padding: 1.15rem 1.25rem;\n  backdrop-filter: blur(var(--tc-glass-blur, 0));\n  -webkit-backdrop-filter: blur(var(--tc-glass-blur, 0));\n  box-shadow: 0 8px 24px rgba(0, 0, 0, 0.2);\n  transition: border-color 0.3s ease, transform 0.2s ease;\n  height: 100%;\n}\n.metric-card:hover {\n  border-color: color-mix(in srgb, var(--tc-primary) 40%, var(--tc-border));\n  transform: translateY(-2px);\n}\n.metric-card.metric-alert {\n  border-color: color-mix(in srgb, var(--tc-critical) 55%, var(--tc-border));\n}\n.metric-icon {\n  width: 2.5rem;\n  height: 2.5rem;\n  border-radius: 0.65rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-size: 1.15rem;\n  color: var(--tc-primary);\n  background: color-mix(in srgb, var(--tc-primary) 16%, transparent);\n  margin-bottom: 0.65rem;\n}\n.metric-card.metric-alert .metric-icon {\n  color: var(--tc-critical);\n  background: color-mix(in srgb, var(--tc-critical) 16%, transparent);\n}\n.metric-value {\n  font-size: 1.9rem;\n  font-weight: 800;\n  font-variant-numeric: tabular-nums;\n  line-height: 1.1;\n}\n.metric-label {\n  font-size: 0.78rem;\n  color: var(--tc-muted);\n  margin-top: 0.15rem;\n}\n.sync-panel {\n  padding: 1.1rem 1.25rem;\n}\n.toast-host {\n  position: fixed;\n  bottom: 1.25rem;\n  right: 1.25rem;\n  z-index: 1080;\n  max-width: min(420px, calc(100vw - 2.5rem));\n}\n.toast-host .toast {\n  display: block;\n  border-radius: 0.75rem;\n  box-shadow: 0 12px 32px rgba(0, 0, 0, 0.35);\n  border: none;\n}\n/*# sourceMappingURL=torre-control.component.css.map */\n"] }]
  }], () => [], null);
})();
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TorreControlComponent, { className: "TorreControlComponent", filePath: "src/app/features/torre-control/torre-control.component.ts", lineNumber: 27 });
})();
export {
  TorreControlComponent
};
//# sourceMappingURL=chunk-4FNCXQND.js.map
