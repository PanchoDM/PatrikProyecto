...
function TorreControlComponent_Conditional_66_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275element(0, "span", 31);
  }
}
...
function TorreControlComponent_Conditional_69_Template(rf, ctx) {
  if (rf & 1) {
...
function TorreControlComponent_Conditional_71_For_2_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 43);
    \u0275\u0275element(1, "app-flight-card", 44);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
    const flight_r1 = ctx.$implicit;
    \u0275\u0275advance();
    \u0275\u0275property("flight", flight_r1);
  }
}
function TorreControlComponent_Conditional_71_Template(rf, ctx) {
  if (rf & 1) {
    \u0275\u0275elementStart(0, "div", 35);
    \u0275\u0275repeaterCreate(1, TorreControlComponent_Conditional_71_For_2_Template, 2, 1, "div", 43, _forTrack0);
    \u0275\u0275elementEnd();
  }
  if (rf & 2) {
...
function TorreControlComponent_Conditional_73_Template(rf, ctx) {
  if (rf & 1) {
    const _r3 = \u0275\u0275getCurrentView();
    \u0275\u0275elementStart(0, "div", 45)(1, "div", 46);
    \u0275\u0275element(2, "i", 47);
    \u0275\u0275elementStart(3, "div", 26)(4, "strong", 48);
    \u0275\u0275text(5);
    \u0275\u0275elementEnd();
    ...
    \u0275\u0275listener("click", function TorreControlComponent_Conditional_73_Template_button_click_8_listener() {
      \u0275\u0275restoreView(_r3);
      const ctx_r1 = \u0275\u0275nextContext();
  ...
  if (rf & 2) {
    const t_r4 = ctx;
    \u0275\u0275classProp("text-bg-success", t_r4.type === "success")("text-bg-danger", t_r4.type === "error");
    \u0275\u0275advance(2);
    \u0275\u0275classProp("bi-check-circle-fill", t_r4.type === "success")("bi-x-circle-fill", t_r4.type === "error");
    \u0275\u0275advance(3);
    \u0275\u0275textInterpolate(t_r4.type === "success" ? "Sincronizacion completa" : "Error de sincronizacion");
    \u0275\u0275advance(2);
    \u0275\u0275textInterpolate(t_r4.message);
  }
}
var TorreControlComponent = class _TorreControlComponent {
  ...
  static \u0275cmp = /* @__PURE__ */ \u0275\u0275defineComponent({ type: _TorreControlComponent, selectors: [["app-torre-control"]], decls: 74, vars: 15, consts: [[1, "container-fluid", "py-4"], [1, "d-flex", "flex-wrap", "align-items-center", "justify-content-between", "gap-3", "mb-4"], [1, "h3", "mb-1"], [1, "d-flex", "align-items-center", "gap-2", "text-body-secondary", "small"], [1, "conn-dot"], [1, "d-flex", "align-items-center", "gap-3"], [1, "legend", "d-none", "d-md-flex"], [1, "legend-item"], [1, "dot", "dot-ok"], [1, "dot", "dot-warning"], [1, "dot", "dot-critical"], [1, "dot", "dot-expired"], ["routerLink", "/nuevo-vuelo", 1, "btn", "btn-primary", "btn-action"], [1, "bi", "bi-plus-lg", "me-2"], [1, "row", "g-3", "mb-4"], [1, "col-6", "col-lg-3"], [1, "metric-card", "fade-in"], [1, "metric-icon"], [1, "bi", "bi-calendar-check"], [1, "metric-value"], [1, "metric-label"], [1, "bi", "bi-arrow-repeat"], [1, "bi", "bi-exclamation-triangle-fill"], [1, "bi", "bi-speedometer2"], [1, "card", "fade-in", "sync-panel", "mb-4"], [1, "d-flex", "flex-wrap", "align-items-end", "gap-3"], [1, "flex-grow-1"], ["for", "csvUrl", 1, "form-label", "small", "fw-semibold", "mb-1"], [1, "bi", "bi-filetype-csv", "me-1"], ["id", "csvUrl", "type", "url", "placeholder", "https://docs.google.com/spreadsheets/d/.../pub?output=csv", 1, "form-control", 3, "ngModelChange", "ngModel", "disabled"], ["type", "button", 1, "btn", "btn-primary", "btn-action", 3, "click", "disabled"], [1, "spinner-border", "spinner-border-sm", "me-2"], [1, "bi", "bi-cloud-arrow-down", "me-2"], [1, "text-center", "text-body-secondary", "py-5"], [1, "empty-state", "text-center", "py-5"], [1, "row", "g-3"], [1, "toast-host"], [1, "toast", "show", "fade-in", 3, "text-bg-success", "text-bg-danger"], ["role", "status", 1, "spinner-border"], [1, "mt-3"], [1, "bi", "bi-airplane", "display-4", "text-body-secondary"], [1, "mt-3", "text-body-secondary"], ["routerLink", "/nuevo-vuelo", 1, "btn", "btn-outline-primary", "btn-action", "mt-2"], [1, "col-12", "col-sm-6", "col-lg-4", "col-xxl-3"], [3, "flight"], [1, "toast", "show", "fade-in"], [1, "d-flex", "align-items-start", "gap-2", "p-3"], [1, "bi", "fs-5"], [1, "d-block", "mb-1"], [1, "small"], ["type", "button", 1, "btn-close", "btn-close-white", 3, "click"]], template: function TorreControlComponent_Template(rf, ctx) {
    if (rf & 1) {
      ...
      \u0275\u0275element(23, "i", 13);
      \u0275\u0275text(24, "Nuevo vuelo ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275elementStart(25, "div", 14)(26, "div", 15)(27, "div", 16)(28, "div", 17);
      \u0275\u0275element(29, "i", 18);
      \u0275\u0275elementEnd();
      ...
      \u0275\u0275text(57, "Eficiencia");
      \u0275\u0275elementEnd()()()();
      \u0275\u0275elementStart(58, "div", 24)(59, "div", 25)(60, "div", 26)(61, "label", 27);
      \u0275\u0275element(62, "i", 28);
      \u0275\u0275text(63, "URL publica CSV de Google Sheets ");
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(64, "input", 29);
      \u0275\u0275listener("ngModelChange", function TorreControlComponent_Template_input_ngModelChange_64_listener($event) {
        return ctx.syncUrl.set($event);
      });
      \u0275\u0275elementEnd()();
      \u0275\u0275elementStart(65, "button", 30);
      \u0275\u0275listener("click", function TorreControlComponent_Template_button_click_65_listener() {
        return ctx.syncFromSheet();
      });
      \u0275\u0275conditionalCreate(66, TorreControlComponent_Conditional_66_Template, 1, 0, "span", 31)(67, TorreControlComponent_Conditional_67_Template, 1, 0, "i", 32);
      \u0275\u0275text(68, " Sincronizar Vuelos ");
      \u0275\u0275elementEnd()()();
      \u0275\u0275conditionalCreate(69, TorreControlComponent_Conditional_69_Template, 4, 0, "div", 33)(70, TorreControlComponent_Conditional_70_Template, 6, 0, "div", 34)(71, TorreControlComponent_Conditional_71_Template, 3, 0, "div", 35);
      \u0275\u0275elementEnd();
      \u0275\u0275elementStart(72, "div", 36);
      \u0275\u0275conditionalCreate(73, TorreControlComponent_Conditional_73_Template, 9, 10, "div", 37);
      \u0275\u0275elementEnd();
    }
    if (rf & 2) {
      let tmp_12_0;
      ...
      \u0275\u0275advance();
      \u0275\u0275conditional(ctx.syncing() ? 66 : 67);
      \u0275\u0275advance(3);
      \u0275\u0275conditional(ctx.loading() ? 69 : ctx.flights().length === 0 ? 70 : 71);
      \u0275\u0275advance(4);
      \u0275\u0275conditional((tmp_12_0 = ctx.toast()) ? 73 : -1, tmp_12_0);
    }
...
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && \u0275setClassDebugInfo(TorreControlComponent, { className: "TorreControlComponent", filePath: "src/app/features/torre-control/torre-control.component.ts", lineNumber: 25 });
})();
export {
  TorreControlComponent
};
//# sourceMappingURL=chunk-K5VYNOTN.js.map
