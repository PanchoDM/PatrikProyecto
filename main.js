...
var routes = [
  ...
  },
  {
    ...
    loadComponent: () => import("./chunk-K5VYNOTN.js").then((m) => m.TorreControlComponent)
  },
  {
    path: "nuevo-vuelo",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-TMB4JGEY.js").then((m) => m.VueloIngresoComponent)
  },
  {
    path: "calendario",
    canActivate: [authGuard],
    loadComponent: () => import("./chunk-UK7UQTIU.js").then((m) => m.CalendarioComponent)
  },
